...
public class StudentApplication {
    ...
    private static void option6() {
        List<Students> studentsList1 = studentDAO.getAllOrderByGpa();
    ...
    private static void option7() {
        List<Students> studentsList2 = studentDAO.getStudentInHaNoi();
        System.out.printf("%-20s %-20s %-20s %-20s %-20s %-20s", "STT","Mã sinh viên", "Họ tên", "Giới tính", "Địa chỉ", "Điểm GPA");
        System.out.println();
    ...
    private static void option8() {
        List<Students> studentsList3 = studentDAO.getStudentSapXepName();
        System.out.printf("%-20s %-20s %-20s %-20s %-20s %-20s", "STT","Mã sinh viên", "Họ tên", "Giới tính", "Địa chỉ", "Điểm GPA");
        System.out.println();

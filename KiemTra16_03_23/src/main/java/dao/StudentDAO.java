...
public class StudentDAO {
    ...
    /**
     * Sắp xếp student theo name anphabet
     * @return students
     */
    ...
    public Students getStudentByID(String id) {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                students.setFullName(resultSet.getString("full_name"));
                students.setGender(resultSet.getInt("gender"));
                students.setNgaySinh(resultSet.getString("ngay_sinh"));
                students.setDiaChi(resultSet.getString("dia_chi"));
                students.setPhoneNumber(resultSet.getInt("phone_number"));
                students.setEmail(resultSet.getString("email"));
                students.setDiemGPA(resultSet.getDouble("diem_gpa"));
            }
            resultSet.close();
            statement.close();
            connection.close();
